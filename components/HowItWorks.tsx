...
const steps = [
  ...
  {
    title: "Sip",
    body: "Tracks when you drink and how steady your routine is—so reminders can land at the right time (concept preview)."
  },
      ...
      <div className="space-y-3">
        {steps.map((s, i) => (
          <button
            ...
            onClick={() => setActive(i)}
            className={cn(
              "tile tile-pressable w-full text-left focus-visible:focus-ring",
              i === active ? "bg-white text-navy" : "bg-white/5 text-white/70"
            )}
