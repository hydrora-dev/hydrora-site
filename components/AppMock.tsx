    ...
    <div className="grid gap-4 lg:grid-cols-3">
      <div className="glass gradient-border relative overflow-hidden rounded-[22px] p-6 shadow-soft lg:col-span-2">
        ...
        <div className="relative">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            <Frame title="Sip timing" metric="09:20 • 11:05" sub="Rhythm overview" />
            <Frame title="Pod usage" metric="Berry Burst" sub="Detected profile" />
          </div>
        </div>
      </div>
      ...
      <div className="glass gradient-border rounded-[22px] p-6 shadow-soft">
        ...
        <ul className="mt-4 space-y-3 text-sm text-white/70">
          <li className="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">Goals and gentle reminders</li>
          <li className="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">Streaks and trend snapshots</li>
          <li className="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">Pod tracking concept</li>
          <li className="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">Dashboard-first design</li>
        </ul>
      </div>
    </div>
  );
