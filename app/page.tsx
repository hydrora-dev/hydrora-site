          ...
          <Reveal>
            <div className="space-y-6">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <Metric title="Hydration % (demo)" number={82} suffix="%" />
                <Metric title="Streak" number={6} suffix=" days" />
                <Metric title="Last pod (demo)" value="—" sub="Not selected" />
              </div>
            </div>
          </Reveal>
        ...
        <section className="grid gap-10 lg:grid-cols-2">
          ...
          <Reveal delay={0.1}>
            <SectionHeader
              ...
              title="Early interest, builder-led."
              subtitle="Feedback from private previews and early conversations. Public testimonials will follow at launch."
            />
            ...
            <div className="mt-4 text-xs text-white/50">
              These statements reflect early discussions and pre-launch previews; final product details may evolve.
            </div>
          </Reveal>
        </section>
    ...
    <div className="tile hover-lift">
      <div className="tile-inner p-4">
        ...
        <div className="mt-2 font-display text-lg text-white">
          {typeof number === "number" ? <CountUp to={number} durationMs={900} suffix={suffix} /> : value}
        </div>
